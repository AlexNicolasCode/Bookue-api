...
var signUpUser = function (name, email, password) { return __awaiter(void 0, void 0, void 0, function () {
    var user;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, user_1.User.create({ name: name, email: email, password: (0, passwordEncoder_1.hashPassword)(password) })];
            case 2:
                _a.sent();
